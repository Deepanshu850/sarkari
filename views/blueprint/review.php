            ...
            <div class="bg-saffron-50 border-2 border-saffron-200 rounded-xl p-6 mb-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        <div class="text-sm text-gray-400 line-through">₹199</div>
                        <span class="text-3xl font-black text-navy-600">₹99</span>
                    </div>
                </div>
...
function resetBtn() {
    var btn = document.getElementById('payBtn');
    btn.disabled = false;
    btn.innerHTML = '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg> Pay ₹99 & Generate';
}
</script>
